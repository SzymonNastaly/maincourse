...
| `screen_wake_lock` | automatically keeps a visible recipe detail awake in supported secure browsers; releases on hide, navigation and Turbo caching, and reacquires when visible again. Browser denial or power-saving revocation is respected without a retry loop |
